...
#task = loop.create_task(get_data_async_concurrently(urls))
#task = loop.create_task(get_data_async_but_as_wrapper(urls))
#loop.run_forever() loop çalışmadı ise 
...
#               eski sürüm
#get_data_async_concurrently(urls) #4 seconds
